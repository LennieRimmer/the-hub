...
begin
  ...
  wwv_flow_imp_page.create_region_column(
    ...
    p_is_visible            => true,
    p_static_id             => 'project-id',
    p_available_clientside  => true,
    p_value_protected       => false,
